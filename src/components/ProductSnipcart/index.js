...
//https://github.com/StanislavSt/stefan-spa/blob/0461ac8ece1545f040d2d12f67e9ab7eadb9bef1/src/components/Work.js
    ...
    <div key={pp.id} style={{ width: "50%" }}>
      <div className="product-container">
        <div
          ...
          onMouseEnter={() => setBackImage(dayBack)}
          onMouseLeave={() => setBackImage(dayFront)}
        >
          <img
            src={backImage}
